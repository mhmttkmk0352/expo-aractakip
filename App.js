...
import { Text, View, Button, TextInput, StyleSheet, Platform } from 'react-native';
...
const styles = StyleSheet.create({
  loginTextInput: {
    borderColor: "#ccc", borderWidth: 1, height:40, borderRadius: 5, textAlign: 'center', marginBottom: 5
  },
  HomeScreenMainView: {
