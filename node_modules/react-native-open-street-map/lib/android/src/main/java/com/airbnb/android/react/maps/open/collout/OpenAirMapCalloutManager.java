...
public class OpenAirMapCalloutManager extends ViewGroupManager<OpenAirMapCallout> {
    ...
    @Override
    public OpenAirMapCallout createViewInstance(ThemedReactContext context) {
        return new OpenAirMapCallout(context);
    }

    @ReactProp(name = "tooltip", defaultBoolean = false)
    public void setTooltip(OpenAirMapCallout view, boolean tooltip) {
    ...
    @Override
    public void updateExtraData(OpenAirMapCallout view, Object extraData) {
